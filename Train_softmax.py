...
if __name__ == "__main__":
    ...
    parser.add_argument('--feat-size', type=int, default=50)
    ...
    for epoch in range(0, args.epoch):
        ...
        for data in trainloader:
            ...
            _, predicted = torch.max(feats.data, 1)
        ...
        if epoch % 10 == 0:
            ...
            plt.savefig('feature_distribution for ResNet18 with CrossEntropy : epoch = %i .png' % epoch)
             # plt.show()
